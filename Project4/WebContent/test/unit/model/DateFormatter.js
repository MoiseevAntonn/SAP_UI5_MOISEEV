sap.ui.require(
	...
	function (DateFormatter,Locale) {
		"use strict";
		var oFormatter = null;
		QUnit.module("Date formatter test",{
			beforeEach : function(){
		...
		QUnit.test("initial", function (assert) {
			assert.ok(oFormatter);
		});
		QUnit.test("should return empty string if no date given", function (assert) {
		...
		QUnit.test("Should return Yesterday if day from yesterday",function(assert){
