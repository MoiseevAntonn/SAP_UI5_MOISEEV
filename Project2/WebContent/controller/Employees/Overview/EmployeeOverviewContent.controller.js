sap.ui.define([
	...
	return BaseController.extend("sap.ui.demo.nav.controller.employee.overview.EmployeeOverviewContent", {
		...
		onInit: function () {
			...
			oRouter.getRoute("appEmployeeOverview").attachMatched(this._onRouteMatched,this);
		},
		...
		onSortButtonPressed : function () {
			...
			this.getRouter().navTo("appEmployeeOverview",this._oRouterArgs)
		},

		onSearchEmployeesTable : function (oEvent) {
			var oRouter = this.getRouter();
			this._oRouterArgs.query.search = oEvent.getSource().getValue();
			oRouter.navTo("appEmployeeOverview",this._oRouterArgs,true);
		},

		_initViewSettingsDialog : function () {
			this._oVSD = new ViewSettingsDialog("vsd", {
				confirm: function (oEvent) {
					this._oRouterArgs.query.sortField = oEvent.getParameter("sortItem").getKey();
					this._oRouterArgs.query.sortDescending = oEvent.getParameter("sortDescending");
					delete this._oRouterArgs.query.showDialog ;
					this.getRouter().navTo("appEmployeeOverview",this._oRouterArgs,true);
				}.bind(this),
